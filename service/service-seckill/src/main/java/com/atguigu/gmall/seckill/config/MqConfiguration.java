...
public class MqConfiguration {
    ...
    public Exchange seckillEventExchange(){
        return new TopicExchange(MqConst.EXCHANGE_SECKILL_EVENT,true,false);
    }


    @Bean
    public Queue seckillQueueQueue(){
        return new Queue(
                MqConst.QUEUEU_SECKILL_QUEUE,
                true,
                false,
                false
        );
    ...
    @Bean
    public Binding seckillQueueQueueBinding(){
        return new Binding(
                MqConst.QUEUEU_SECKILL_QUEUE,
