...
public class PayServiceImpl implements PayService {
    ...
    public String generatePayPage(Long orderId) throws AlipayApiException {
        ...
        OrderInfo orderInfo = orderFeignClient.getOrderInfoAndUserId(orderId).getData();
        ...
        //自动收单
        String formatDate = DateUtil.formatDate(orderInfo.getExpireTime(), "yyyy-MM-dd HH:mm:ss");
        body.put("time_expire", formatDate);
    ...
    public boolean checkSign(Map<String, String> params) throws AlipayApiException {
        ...
        boolean checked = AlipaySignature.rsaCheckV1(params,
